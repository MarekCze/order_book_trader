...
3. **Volatility filter:** Skip if the 5-minute ATR is below the 20th percentile of its trailing 20-day distribution (dead market → absorption signals are noise) or above the 95th percentile (news-driven market → levels don't hold).
